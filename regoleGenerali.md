...
Se l'acronimo deriva da un termine in lingua straniera va indicato, con la rispettiva traduzione, ad esempio in "ambiente di sviluppo integrato (IDE, dall'inglese Integrated Development Environment)". I testi in lingua straniera seguono le [convenzioni relative](tipografiaConvensioniFont.md#linguaStraniera).
